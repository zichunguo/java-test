...
//    private long lastStamp = 1577808000001L;//上一次时间戳，用于测试
	/** 时钟是否回退的标志 */
...
//    	return (id >> TIMESTAMP_LEFT & ~(-1L << 41L)) + START_STAMP;
	}
...
//    	return (id >> DATA_CENTER_BIT) & MAX_DATA_CENTER_NUM;
		return id >> DATA_CENTER_LEFT & ~(-1L << DATA_CENTER_BIT);
	}
